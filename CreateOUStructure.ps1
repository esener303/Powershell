...
Function Create-OuStructure{
    ...
    Param(
        [Parameter(Mandatory = $True,
                   HelpMessage = 'This will create an OU name test in the location dc=azure-lab,dc=loca. containing the OU name and OU path')]
        [String]$entry
    )
...
$entry 
{
    ...
    Else {
        ...
        Write-Host -ForegroundColor Yellow "OU $ouname is created in the location $oupath"}
}
